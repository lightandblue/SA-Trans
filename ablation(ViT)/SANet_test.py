...
import os, argparse
import cv2
from models.SANet_vit import SANetV2
...
parser.add_argument('--test_path', type=str, default=os.getcwd() + '/SANetV2-vit/LFSOD_dataset/RGBD_for_test/', help='test dataset path')
...
#load the model
model = SANetV2()
model.load_state_dict(torch.load(os.getcwd() + '/SANetV2-vit/SA+VIT/models_test/SANet_epoch_45.pth'))
model.cuda()
model.eval()
...
for dataset in test_datasets:
    save_path = './test_maps/SANet+ViT/' + dataset + '/img/'
